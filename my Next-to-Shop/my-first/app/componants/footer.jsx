...
export default function Footer() {
  return (
    <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 border-t border-gray-200 mt-10">
        ...
        <div className="md:max-w-md lg:col-span-2">
          ...
          <div className="mt-4 lg:max-w-sm">
            ...
            <p className="mt-4 text-sm text-gray-800">
              Join our community and experience the best online shopping experience.
            </p>
          </div>
        </div>
      ...
      <div className="flex flex-col justify-between pt-5 pb-10 border-t border-gray-100 sm:flex-row">
        <p className="text-sm text-gray-600">
          © Copyright 2024 MyShop Inc. All rights reserved.
        </p>
